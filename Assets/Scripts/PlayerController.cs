...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("PickUp"))
        {
            ...
            myAudioSource.PlayOneShot(clip, soundFxVolume);
        }
    }
...
public void StartGameSound()
    ...
    {
        Material playerMat = Resources.Load("Materials/Player", typeof(Material)) as Material;
        Material player1Mat = Resources.Load("Materials/Player1", typeof(Material)) as Material;
        if (player1Mat == GetComponent<Renderer>().material)
        {
            Debug.Log("Default mat");
